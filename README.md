...
| `threshold-icons`           | A JSON object mapping coverage percentage thresholds to status icons. This always determines the status icon shown in coverage reports. See [Threshold Icons](#threshold-icons) for details.                                                          | ''                                                                                                                                                                                                                                                                 |
