...
| `sort-by`                   | How to order files within each file coverage group. Possible values are `name` (preserve vitest's collection order), `coverage-asc` (statements coverage ascending — worst first), or `coverage-desc` (statements coverage descending — best first).                                                                              | `name`                                                                                                                                                                                                                                                             |
